...
import {ITokenRoyaltySaleFactoryV2} from "../../V2/FactoryV2/TokenRoyaltySaleFactoryV2.sol";
...
contract TokenRoyaltySaleV3 is ReentrancyGuard, Pausable {
    ...
    function initialize(uint _royaltyPoolSize, uint _percentage, address _tokenRoyaltyFactory, address _creator, string memory _creatorsName, string memory _name) external {
    ...
    function withdraw() external onlyOwner {
        ...
        (address royaltyAddress, uint royaltyPercentage) = ITokenRoyaltySaleFactoryV2(royalty.tokenRoyaltyFactory).getRoyaltyDetails();
