...
describe("NftRoyaltySaleV3", function () {
  const maxSupply = 100;
  ...
  let linkToken;
  let payoutToken;
  let oracle = "0xdafea492d9c6733ae3d56b7ed1adb60692c98bc5";
  let jobId = "jeiocdh2n5678dbn5589jno8";
  ...
  it("only regstrar setup automation", async () => {
    ...
    await expect(
      nftRoyaltySale
        .connect(user2)
        .setupAutomationV2(timeInterval, royaltyAdapter.address, oracle, jobId)
  ...
  it("ownly owner can withdraw", async () => {
    ...
    await nftRoyaltySale.endRoyaltySale();
